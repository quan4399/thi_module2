    ...
    <div class="card">
        ...
        <form class="p-3 mb-2 " action="" method="POST">
            <div class="col-6 container">
                ...
                <input type="text" class="form-control " id="inputN" name="nameProduct" placeholder="Name">
            ...
            <div class="col-6 container">
                ...
                <select name="typeProduct" id="">
                    ...
                    <option value="Tủ Lạnh">Máy tính</option>
                </select>

            </div>
            <div class="col-6 container">
                <label for="inputA" class="form-label">Price</label>
                <input type="text" class="form-control " id="inputA" name="priceProduct" placeholder="Price">
            </div>
            <div class="col-6 container">
                <label for="inputJ" class="form-label">Quantity</label>
                <input type="text" class="form-control " id="inputJ" name="quantityProduct" placeholder="Quantity">

            </div>
            <div class="col-6 container">
                <label for="inputJs" class="form-label">Date Created</label>
                <input type="date" class="form-control " id="inputJs" name="dateCreate">

            </div>
            <div class="col-6 container">
                <label for="inputJ" class="form-label">Description</label>
                <input type="text" class="form-control " id="inputJ" name="description"
